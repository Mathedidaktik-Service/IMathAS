...
if ($isOldChrome) {
  echo '<script defer="defer" src="'.$staticroot.'/assess2/vue/js/gbviewassess-legacy.js?v=Btkl9Coc"></script>';
} else {
?>
<script defer="defer" type="module" src="<?php echo $staticroot;?>/assess2/vue/js/gbviewassess.js?v=Ca7CXuN0"></script>
<script defer="defer" nomodule src="<?php echo $staticroot;?>/assess2/vue/js/gbviewassess-legacy.js?v=Btkl9Coc"></script>
<?php
}
