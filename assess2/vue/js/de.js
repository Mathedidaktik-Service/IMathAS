...
launch-scorelist = Punkteübersicht\r
launch-itemanalysis = Einzel-Analyse\r
launch-gblinks = Links zurPunkteübersicht\r
launch-a11ywarn = Wenn Sie einen Screenreader nutzen, so sollten Sie die Optionen zur Barrierefreiheit für den Graph und die Zeichenwerkzeuge aktivieren.\r
\r
# Closed section\r
...
closed-retakewait = Dieser Test erfordert eine Pause, ehe Du ihn erneut versuchen kannst.Du kannst den Test noch einmal machen ab: {$date}.\r
closed-latepassn = \r
    { $n ->\r
...
setlist-penalty_after = Nach dem {$date} wird ein Punktabzug von {$p}% fällig.\r
setlist-earlybonus = Ein Bonus von {$p}% wird bis zum {$date} gewährt.\r
setlist-penalty_interval = Für verspätet eingereichte Arbeiten wird ein Punktabzug von {$p}% alle {$hrs} Stunden angewendet; aktuell gilt ein Punktabzug von {$cur}%.\r
setlist-penalty_interval_after = Ein Punktabzug von {$p}% wird alle {$hrs} Stunden angewendet nach {$date}.\r
setlist-take = \r
    { $n ->\r
...
setlist-submitnote = Schicken Sie Ihren nicht eingereichten Versuch zur Bewertung ab.\r
setlist-submitretake = Schicken Sie Ihren nicht eingereichten Versuch zur Bewertung und für die Möglichkeit eines neuen Versuches ab.\r
setlist-latepass_needed = \r
    { $n ->\r
        [one] Sie können ein Kulanzguthaben einlösen, um das Fälligkeitsdatum auf {$date} zu verlängern\r
        *[other] Sie können {$n} Kulanzguthaben einlösen, um das Fälligkeitsdatum auf den {$date} zu verlängern\r
    }\r
setlist-retakewait = \r
    { $n ->\r
        [one] Sie müssen für einen neuen Versuch eine Stunde warten\r
        *[other] Sie müssen zwischen Versuchen {$n} Stunden warten\r
    }\r
    \r
\r
# Group\r
...
question-showwork_n = Lösungsweg für Frage {$n}\r
question-uploadwork = Fügen Sie Ihren Lösungsweg hier als Datei oder Bild an\r
...
\r
# Drill\r
drill-goal_time_maxcorrect = Versuche in {$n} Sekunden so viele Fragen wie möglich zu beantworten.\r
drill-goal_count_time = Beantworte {$n} Fragen so schnell wie möglich.\r
drill-goal_count_correct_time = Beantworte {$n} Fragen so schnell wie möglich richtig.\r
drill-goal_count_correct_attempts = Beantworte {$n} Fragen richtig mit möglichst wenig Fehlern.\r
drill-goal_streak_time = Beantworte so schnell wie möglich {$n} Fragen hintereinander richtig.\r
drill-goal_streak_attempts = Beantworte {$n} Fragen hintereinander richtig mit möglichst wenig Fehlern.\r
drill-start = Start\r
drill-incorrect_tryagain = Leider falsch. Versuch es noch einmal.\r
drill-partial_tryagain = Teilweise falsch. Versuch es noch einmal.\r
drill-correct_next = Richtig. Versuche die nächste Frage.\r
drill-incorrect_next = Leider falsch - und es sind keine Versuche mehr übrig. Versuche die nächste Frage.\r
drill-partial_next = Teilweise falsch - und es sind keine Versuche mehr übrig. Versuche die nächste Frage.\r
drill-outoftries = Keine Versuche mehr übrig. Sieh Dir unten die Antworten an und fahre dann fort.\r
drill-next = Nächste Frage\r
drill-complete = Gute Arbeit!\r
drill-restart = Versuche es noch einmal.\r
drill-result_time_maxcorrect =\r
    { $correct ->\r
        [one] In {$n} Sekunden 1 Frage richtig.\r
        *[other] In {$n} Sekunden, {$correct} Fragen richtig.\r
    }\r
drill-result_count_time =\r
    { $n ->\r
        [one] Eine Frage in {$time} Sekunden versucht.\r
        *[other] {$n} Fragen in {$time} Sekunden versucht.\r
    }\r
drill-result_count_correct_time =\r
    { $n ->\r
        [one] Eine Frage richtig in {$time} Sekunden.\r
        *[other] {$n} Fragen richtig in {$time} Sekunden.\r
    }\r
drill-result_count_correct_attempts =\r
    { $n ->\r
        [one] Eine Frage  richtig in {$attempts} Versuchen.\r
        *[other] {$n} Fragen richtig in {$attempts} Versuchen.\r
    }\r
drill-result_streak_time =\r
    { $n ->\r
        [one] Serie mit einer Frage richtig in {$time} Sekunden.\r
        *[other] Serie mit {$n} Fragen hintereinander richtig in {$time} Sekunden.\r
    }\r
drill-result_streak_attempts =\r
    { $n ->\r
        [one] Serie mit einer Frage richtig in {$attempts} Versuchen.\r
        *[other] Serie mit {$n} Fragen hintereinander richtig in {$attempts} Versuchen.\r
    }\r
drill-progress_time_maxcorrect =\r
    { $count ->\r
        [one] Fortschritt: 1 Frage richtig.\r
        *[other] Fortschritt: {$count} Fragen richtig.\r
    }\r
drill-progress_count_time = Fortschritt: {$count} von {$n} Fragen versucht.\r
drill-progress_count_correct = Fortschritt: {$count} von {$n} Fragen richtig beantwortet.\r
drill-progress_streak = Fortschritt: Serie von {$count} von {$n} hintereinander richtig.\r
drill-best_correct = Persönliche Bestleistung: {$n} richtig\r
drill-best_time = Persönliche Bestleistung: {$n} Sekunden\r
drill-best_attempts = Persönliche Bestleistung: {$n} Versuche\r
drill-history_title = Trainingsverlauf\r
\r
# Header\r
...
header-drills_completed = Abgeschlossene Trainings: {$n}/{$tot}\r
...
header-confirm_assess_submit = Nach dem Einreichen kannst Du Deine Antworten in dieser Version des Tests nicht mehr ändern. Willst Du sie einreichen?\r
header-confirm_assess_unattempted_submit = Es scheint, Du hast noch nicht alle Fragen versucht. Nach Abgabe des Tests kannst Du Deine Antworten in dieser Version des Tests nicht mehr ändern. Willst Du jetzt wirklich einreichen?\r
header-confirm_assess_nowork_submit = Du hast noch keine Lösungswege hinzugefügt. Nach dem Einreichen kannst Du zu dieser Testversion nichts mehr hinzufügen. Willst Du jetzt einreichen?\r
...
error-workafter_expired = Die Frist für das Hinzufügen weiterer Lösungen ist abgelaufen.\r
error-workafter_submitting = Die Frist für das Hinzufügen weiterer Lösungen ist abgelaufen. Die Daten werden jetzt gespeichert.\r
...
scoreresult-jumptoincorrect = Springe zum ersten fehlerhaften Teil, der verändert werden kann.\r
scoreresult-jumptoincorrectstart = Gehe zum Anfang des ersten fehlerhaften Teils, der geändert werden kann\r
...
seqresult-incorrect = Eine oder mehrere Antworten sind falsch\r
seqresult-continue = An diesem Teil weiter arbeiten\r
seqresult-next = Weiter zum nächsten Teil\r
\r
# Summary\r
...
summary-viewwork_work_scores_after = Sie können Ihre Arbeit und die Bewertungen nach dem Abgabetermin in der Notenübersicht einsehen.\r
summary-viewwork_work_after_lp = Sie können Ihre Arbeit nach Ablauf der Nachfrist in der Notenübersicht einsehen.\r
summary-viewwork_after_lp = Sie können Ihre Arbeiten und Noten nach Ablauf der Nachfrist in der Notenübersicht einsehen.\r
...
penalties-early = Bonus für vorzeitiges Einreichen\r
...
gradebook-savenext = Speichern und zum nächsten Studierenden wechseln\r
...
gradebook-hide_fb = Fragen mit Rückmeldung\r
gradebook-hide_nowork = Fragen ohne Lösungsweg\r
gradebook-hide_unans = Unbeantwortete Fragen ausblenden\r
...
gradebook-show_all_work = Alle Lösungswege anzeigen\r
...
gradebook-avail_manual = Die Note wird derzeit vom Dozenten ausgeblendet.\r
...
gradebook-avail_after_lp = Wird nach Ablauf der Kulanz-Periode angezeigt.\r
...
gradebook-latepass_blocked_gb = Die Verwendung eines Kulanzguthabens ist derzeit gesperrt, da der/die Studierende die Bewertung in der Notenübersicht eingesehen hat.\r
gradebook-latepass_blocked_lpcutoff = Die Verwendung eines Kulanzguthabens ist derzeit blockiert, da das Ablaufdatum für das Kulanzguthaben überschritten wurde.\r
gradebook-latepass_blocked_courseend = Die Nutzung von Kulanzguthaben ist derzeit blockiert, da das Kursende bereits überschritten ist.\r
gradebook-latepass_blocked_pastdue = Die Verwendung von Kulanzguthaben ist derzeit blockiert, da das Fälligkeitsdatum überschritten wurde und der Test so eingestellt ist, dass Kulanzguthaben nur vor dem Fälligkeitsdatum verwendet werden können.\r
gradebook-latepass_blocked_toolate = Die Verwendung von Kulanzguthaben ist derzeit blockiert, da der Abgabetermin so weit überschritten ist, dass eine erneute Abgabe mithilfe der erlaubten Anzahl von Kulanzguthaben nicht mehr möglich ist.\r
gradebook-latepass_blocked_toofew = Die Verwendung von Kulanzguthaben ist derzeit blockiert, da der/die Studierende nicht über genügend Kulanzguthaben verfügt.\r
...
gradebook-floating_scoreboxes = Bewegliche Punktanzeigen\r
...
gradebook-oneatatime = Eine nach der anderen\r
gradebook-a11yalt = Barrierefreie Alternative\r
...
gradebook-manualstatus0 = Die Note wurde der/dem Studierenden noch nicht mitgeteilt.\r
gradebook-manualbutton0 = Freigabestufe\r
gradebook-manualstatus1 = Die Note wurde der/dem Studierenden mitgeteilt.\r
gradebook-manualbutton1 = Nicht freigegebene Version\r
gradebook-release_on_save = Bewertung nach dem Speichern für die/den Studierenden freigeben.\r
\r
# Work\r
...
work-add_prev = Du kannst noch deine Ihre Lösung für den aktuellsten Versuch einreichen\r
work-remove = Bist Du sicher, dass Du diese Datei entfernen möchtest?\r
work-all = Füge hier für alle Fragen Lösungswege hinzu\r
work-gbtitle = Lösungsweg\r
\r
# Regions\r
...
\r
# LatePass reasons\r
latepass-reason0 = Verspätete Anmeldungen sind nicht erlaubt.\r
latepass-reason2 = Kulanzguthaben können nicht verwendet werden, da die Frist für die Nutzung von Kulanzguthaben abgelaufen ist.\r
latepass-reason3 = Kulanzguthaben können nicht verwendet werden, da das Kursende bereits überschritten ist.\r
latepass-reason4 = Kulanzguthaben können nicht verwendet werden, da das Enddatum für die Bewertung überschritten ist und Kulanzguthaben nur vor diesem Zeitpunkt verwendet werden können.\r
latepass-reason5 = KUlanzguthaben können nicht verwendet werden, da der Abgabetermin für die zulässige Anzahl an Kulanzguthaben bereits zu lange überschritten ist, um die Abgabefrist erneut zu verlängern.\r
latepass-reason6 = Kulanzguthaben können nicht verwendet werden, da Sie nicht genügend Kulanzguthaben besitzen, um dies erneut zu öffnen.\r
latepass-reason7 = Kulanzguthaben können nicht verwendet werden, da Sie diese Bewertung im Übungsmodus geöffnet haben. In diesem Modus können Kulanzguthaben nicht genutzt werden.\r
latepass-reason8 = LatePässe können nicht verwendet werden, da Sie diese Bewertung in der Notenübersicht bereits eingesehen haben, und dies die Verwendung von Kulanzguthaben blockiert.\r
latepass-reason9 = Kulanzguthaben können nicht verwendet werden, da Sie keine Versuche mehr übrig haben.\r
latepass-reason10 = Kulanzguthaben können nicht genutzt werden weil der Punktabzug bereits 100% oder mehr beträgt.\r
`;export{e as default};