...
?>
<link rel="stylesheet" href="<?php echo $staticroot . "/imascore.css?ver=071226";?>" type="text/css">
<?php
$isfw = false;
...
if (isset($coursetheme)) {
	echo '<link rel="stylesheet" href="'. $staticroot . "/themes/$coursetheme?v=083026\" type=\"text/css\">";
}
